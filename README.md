...
Open these before changing simulator logic:

- The `Example Output` section in this README: the fastest preview of what the simulator returns.
- `data/loans.csv`: the sample input to replace first.
- Console output from `python3 src/main.py`: the generated Snowball vs Avalanche comparison.
